program compare_exp2
implicit none

  include 'netcdf.inc'

  integer, parameter :: IM = 361
  integer, parameter :: JM = 145
  integer, parameter :: year_i = 2009 
  integer, parameter :: month_i = 6 
  integer, parameter :: day_i = 30
  real, parameter :: eps = 1e-36 
  real, parameter :: eps_r = 1e-2
  character * 32,parameter :: prefix="global_ncep_wav_"
  integer * 4 :: rcode
  integer :: status
  integer :: NCID
  ...
  openfile1 = "../../exp/exp2/"//trim(prefix)//year_s//month_s//day_s//".nc"
