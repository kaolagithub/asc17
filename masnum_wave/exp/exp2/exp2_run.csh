...
set depfile = $masnum_home/inputdata/topo/topo_global_1deg.nc
...
set title      = "global_ncep"    # --- Symbal for model output.
set istime     = 20090101      # --- Integral start time
set ietime     = 20090601      # --- Integral end time
set cools_days = 0             # --- The time (days) for cool start.
set delttm     = 15           # --- Length of integral time step, in minutes.
                               # --- Maximum value is 20 in this example
...
bsub -I -n 2 -q q_sw_expr -share_size 6000 -host_stack 1024 -b -m 1 -o out.qrunout ./masnum.wam.mpi
